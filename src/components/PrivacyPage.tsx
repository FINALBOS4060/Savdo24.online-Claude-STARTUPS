  ...
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-8 space-y-8 animate-fade-in text-left">
      <div className="flex items-center gap-3 border-b border-white/10 pb-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-on-primary-container">Maxfiylik siyosati</h1>
      ...
      <div className="space-y-6 text-sm text-gray-300 leading-relaxed font-medium">
        <section className="space-y-3">
          <h2 className="text-base font-bold text-on-primary-container uppercase tracking-wider text-secondary">1. Umumiy qoidalar</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-on-primary-container uppercase tracking-wider text-secondary">2. To'planadigan ma'lumotlar</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-on-primary-container uppercase tracking-wider text-secondary">3. Ma'lumotlardan foydalanish maqsadlari</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-on-primary-container uppercase tracking-wider text-secondary">4. Ma'lumotlarni himoya qilish va saqlash</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-on-primary-container uppercase tracking-wider text-secondary">5. Ma'lumotlarni uchinchi tomonlarga berilmasligi</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-on-primary-container uppercase tracking-wider text-secondary">6. Cookie fayllari</h2>
          <p>
