    ...
    <div className="max-w-4xl mx-auto p-6 md:p-8 space-y-8 animate-fade-in text-left">
      ...
      <div className="space-y-6 text-sm text-gray-300 leading-relaxed font-medium">
        <section className="space-y-3">
          <h2 className="text-base font-bold text-white uppercase tracking-wider text-[#f3ba2f]">1. Umumiy qoidalar</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-white uppercase tracking-wider text-[#f3ba2f]">2. To'planadigan ma'lumotlar</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-white uppercase tracking-wider text-[#f3ba2f]">3. Ma'lumotlardan foydalanish maqsadlari</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-white uppercase tracking-wider text-[#f3ba2f]">4. Ma'lumotlarni himoya qilish va saqlash</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-white uppercase tracking-wider text-[#f3ba2f]">5. Ma'lumotlarni uchinchi tomonlarga berilmasligi</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-white uppercase tracking-wider text-[#f3ba2f]">6. Cookie fayllari</h2>
          <p>
